...
//}
//
//protocol DecodableOptional: ExpressibleByNilLiteral {
//    static var wrappedType: Decodable.Type { get }
//}
//
//extension Optional: DecodableOptional where Wrapped: Decodable {
//    static var wrappedType: any Decodable.Type {
//        Wrapped.self
//    }
//}
//extension Nullable: DecodableOptional where Wrapped: Decodable {
//    public init(nilLiteral: ()) { wrappedValue = nil }
//    static var wrappedType: any Decodable.Type {
//        Wrapped.self
//    }
//}
